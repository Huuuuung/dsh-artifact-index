...
export function apply(ctx, config = {}) {
  // Cordis passes this plugin's resolved configuration as the second argument.
  // Reading ctx.config would instead request a service named "config" and is
  // rejected unless that service is explicitly injected.
  const cfg = { ...(config ?? {}) }
